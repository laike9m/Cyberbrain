...
def test_inplace_operations(tracer, rpc_stub):
    ...
    assert tracer.event_sequence == [
        ...
        Binding(
            target=Symbol("a1"), value=4, sources={Symbol("a1"), Symbol("b")}, lineno=11
        ),
        InitialValue(target=Symbol("a2"), value=2, lineno=12),
        Binding(
            target=Symbol("a2"), value=4, sources={Symbol("a2"), Symbol("b")}, lineno=12
        ),
        InitialValue(target=Symbol("a3"), value=2, lineno=13),
        Binding(
            target=Symbol("a3"), value=1, sources={Symbol("a3"), Symbol("b")}, lineno=13
        ),
        ...
        Binding(
            target=Symbol("a5"), value=0, sources={Symbol("a5"), Symbol("b")}, lineno=15
        ),
        InitialValue(target=Symbol("a6"), value=2, lineno=16),
        Binding(
            target=Symbol("a6"), value=4, sources={Symbol("a6"), Symbol("b")}, lineno=16
        ),
        InitialValue(target=Symbol("a7"), value=2, lineno=17),
        Binding(
            target=Symbol("a7"), value=0, sources={Symbol("a7"), Symbol("b")}, lineno=17
        ),
        InitialValue(target=Symbol("a8"), value=2, lineno=18),
        Binding(
            target=Symbol("a8"), value=8, sources={Symbol("a8"), Symbol("b")}, lineno=18
        ),
        InitialValue(target=Symbol("a9"), value=2, lineno=19),
        Binding(
            target=Symbol("a9"), value=0, sources={Symbol("a9"), Symbol("b")}, lineno=19
        ),
